...
const Remove = styled.i`margin:2px;`
const Add = styled.i`margin:2px`
const Hr = styled.hr`
     ...
     {cart.products.map(product=>(
      <Product>
        ...
        <PriceDetail>
            ...
            <ProductPrice>{product.price*product.quantity} USD</ProductPrice>
        </PriceDetail>
    </Product>))}
    <Hr/>
</Info>
<Summary>
    ...
    <SummaryItem>
        ...
        <SummaryItemPrice>0 usd </SummaryItemPrice>
    </SummaryItem>
